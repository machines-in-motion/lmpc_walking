...
no_desired_steps      = 5                                 # number of desired walking steps
no_planned_steps      = 10*no_desired_steps                 # making sure to plan 2 steps ahead
...
for i in range(desired_walking_time):
    ...
    [X_k, Y_k, Z_x_k, Z_y_k] = motionModel.compute_recursive_dynamics(P_ps,\
                                            P_vs, P_zs, P_pu, P_vu, P_zu, N,\
